...
function LayoutVariant2({ description, inTemplate, ...props }) {
  return (
    <fieldset className="fieldset-drop-in">
      ...
      <div className="container full-width">
        <div className="column">
          ...
          <ComponentSelector
            {...props}
            name={props.getFieldName("layout-2-manchete")}
            componentFilter={el =>
        ...
        <div className="column">
          ...
          <div className="container">
            ...
            <div className="column no-border">
              <ComponentSelector
                {...props}
                name={props.getFieldName("layout-2-destaque-com-foto-1")}
            ...
            <div className="column no-border">
              <ComponentSelector
                {...props}
                name={props.getFieldName("layout-2-destaque-com-foto-2")}
                componentFilter="drop-in-highlight"
                allowAdd={inTemplate}
              />
            </div>
            ...
            <div className="column no-border">
              <ComponentSelector
                {...props}
                name={props.getFieldName("layout-2-destaque-com-foto-3")}
                componentFilter="drop-in-highlight"
                allowAdd={inTemplate}
              />
            </div>
            <div className="column no-border">
              <ComponentSelector
                {...props}
                name={props.getFieldName("layout-2-destaque-com-foto-4")}
                componentFilter="drop-in-highlight"
                allowAdd={inTemplate}
              />
            </div>
